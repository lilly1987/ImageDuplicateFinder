...
REQUIRED_KEYS = {
    ...
    "remove_empty_folders": "Delete Empty Folders",
    "total": "Total",
    ...
    "open_group_folders": "Open Group Folders",
    ...
    "no_empty_folders": "No empty folders found.",
    "delete_empty_folders_confirm": "Delete {count} empty folder(s) with no files?",
    "delete_empty_folders_done": "{count} empty folder(s) deleted.",
    "group_count": "Count",
    "group_name": "Group",
    "file_path": "File Path",
    "check": "Check",
    ...
    "tooltip_remove_empty_folders": "Delete folders (including subfolders) that contain no files, and remove them from the list.",
    ...
    "tooltip_open_group_folders": "Open in Explorer every folder containing a file of the currently selected group (duplicate folders are opened only once).",
